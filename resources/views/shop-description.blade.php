                        ...
                        <div class="card-body">
                            <div class="productdec text-center">
                                <div class="bg-light-gray p-6 text-center">
                                    <img alt="Product" src="{{URL::asset('assets/images/pngs/6.png')}}" class="border p-2">
                                </div>
                            </div>
                                ...
                                <div class="carousel-inner ">
                                    <div class="carousel-item">
                                        ...
                                        <div class="carouselproduct mt-4 text-center">
                                            <h5 class=""><a href="{{url('/' . $page='product-details')}}">Chair</a></h5>
                                    ...
                                    <div class="carousel-item active">
                                        ...
                                        <div class="carouselproduct mt-4 text-center">
                                            <h5 class=""><a href="{{url('/' . $page='product-details')}}">T-Shirt</a></h5>
                                            <ul class="product_price list-unstyled">
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <div class="carouselproduct mt-4 text-center">
                                            <h5 class=""><a href="{{url('/' . $page='product-details')}}">Leather Watch</a></h5>
                                            <ul class="product_price list-unstyled">
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <div class="carouselproduct mt-4 text-center">
                                            <h5 class=""><a href="{{url('/' . $page='product-details')}}">Hand Bag</a></h5>
                                            <ul class="product_price list-unstyled">
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <div class="carouselproduct mt-4 text-center">
                                            <h5 class=""><a href="{{url('/' . $page='product-details')}}">Kids Wear</a></h5>
                                            <ul class="product_price list-unstyled">
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <div class="carouselproduct mt-4 text-center">
                                            <h5 class=""><a href="{{url('/' . $page='product-details')}}">Desktop</a></h5>
                                            <ul class="product_price list-unstyled">
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <div class="carouselproduct mt-4 text-center">
                                            <h5 class=""><a href="{{url('/' . $page='product-details')}}">Pot</a></h5>
                                            <ul class="product_price list-unstyled">
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <div class="carouselproduct mt-4 text-center">
                                            <h5 class=""><a href="{{url('/' . $page='product-details')}}">Sport shooes</a></h5>
                                            <ul class="product_price list-unstyled">
