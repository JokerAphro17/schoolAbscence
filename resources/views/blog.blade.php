...
@section('content')
			...
			<div class="row row-cards row-deck">
				<div class="col-md-4">
					<div class="card">
						<img class="card-img-topbr-tr-5 br-tl-5" src="{{URL::asset('assets/images/media/19.jpg')}}" alt="Card image cap">
				...
				<div class="col-md-4">
					<div class="card">
						<img class="card-img-top br-tr-5 br-tl-5" src="{{URL::asset('assets/images/media/12.jpg')}}" alt="Card image cap">
						<div class="card-header">
							<h5 class="card-title">Blog title</h5>
						</div>
						<div class="card-body">
				...
				<div class="col-md-4">
					<div class="card ">
						<img class="card-img-top br-tr-5 br-tl-5" src="{{URL::asset('assets/images/media/17.jpg')}}" alt="Card image cap">
						<div class="card-header">
							<h5 class="card-title">Blog title</h5>
						</div>
						<div class="card-body">
				...
				<div class="col-md-4">
					<div class="card">
						<img class="card-img-top br-tr-5 br-tl-5" src="{{URL::asset('assets/images/media/20.jpg')}}" alt="Card image cap">
						<div class="card-header">
							<h5 class="card-title">Blog title</h5>
						</div>
						<div class="card-body">
				...
				<div class="col-md-4">
					<div class="card ">
						<img class="card-img-top br-tr-5 br-tl-5" src="{{URL::asset('assets/images/media/23.jpg')}}" alt="Card image cap">
						<div class="card-header">
							<h5 class="card-title">Blog title</h5>
						</div>
						<div class="card-body">
				...
				<div class="col-md-4">
					<div class="card ">
						<img class="card-img-top br-tr-5 br-tl-5" src="{{URL::asset('assets/images/media/22.jpg')}}" alt="Card image cap">
						<div class="card-header">
							<h5 class="card-title">Blog title</h5>
						</div>
						<div class="card-body">
				...
				<div class="col-sm-6 col-xl-3">
					<div class="card">
						<a href="#"><img class="card-img-top br-tr-5 br-tl-5" src="{{URL::asset('assets/images/media/13.jpg')}}" alt="And this isn&#39;t my nose. This is a false one."></a>
						<div class="card-body d-flex flex-column">
							...
							<div class="d-flex align-items-center pt-5 mt-auto">
								...
								<div>
									<a href="{{url('/' . $page='profile')}}" class="text-default">Megan Peters</a>
				...
				<div class="col-sm-6 col-xl-3">
					<div class="card">
						<a href="#"><img class="card-img-top br-tr-5 br-tl-5" src="{{URL::asset('assets/images/media/14.jpg')}}" alt="Well, I didn&#39;t vote for you."></a>
						<div class="card-body d-flex flex-column">
							<h4><a href="#">voluptatem quia voluptas.</a></h4>
							...
							<div class="d-flex align-items-center pt-5 mt-auto">
								...
								<div>
									<a href="{{url('/' . $page='profile')}}" class="text-default">Anna Ogden</a>
					...
					<div class="card">
						<div class="card-body d-flex flex-column">
							...
							<div class="d-flex align-items-center pt-5 mt-auto">
								...
								<div>
									<a href="{{url('/' . $page='profile')}}" class="text-default">Carol Paige</a>
									<small class="d-block text-muted">2 days ago</small>
								</div>
								<div class="ml-auto text-muted">
									<a href="javascript:void(0)" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i></a>
						...
						<a href="#"><img class="card-img-top br-bl-5 br-br-5" src="{{URL::asset('assets/images/media/15.jpg')}}" alt="How do you know she is a witch?"></a>
					</div>
				</div><!-- COL-END -->
				<div class="col-sm-6 col-xl-3">
					<div class="card">
						<div class="card-body d-flex flex-column">
							...
							<div class="d-flex align-items-center pt-5 mt-auto">
								...
								<div>
									<a href="{{url('/' . $page='profile')}}" class="text-default">Fiona Hodges</a>
						...
						<a href="#"><img class="card-img-top br-bl-5 br-br-5" src="{{URL::asset('assets/images/media/16.jpg')}}" alt="Shut up!"></a>
					</div>
				</div><!-- COL-END -->
				<div class="col-lg-6">
					<div class="card card-aside">
						<a href="#" class="card-aside-column br-tl-5  br-bl-5 cover-image" data-image-src="{{URL::asset('assets/images/media/17.jpg')}}"></a>
						<div class="card-body d-flex flex-column">
					...
					<div class="card card-aside">
						<div class="card-body d-flex flex-column">
							...
							<div class="d-flex align-items-center pt-5 mt-auto">
								<div class="avatar  brround avatar-md mr-3 cover-image" data-image-src="{{URL::asset('assets/images/users/16.jpg')}}"></div>
								<div>
									<a href="{{url('/' . $page='profile')}}" class="text-default">Irene Scott</a>
									<small class="d-block text-muted">2 days ago</small>
								</div>
								<div class="ml-auto text-muted">
									<a href="javascript:void(0)" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i></a>
						...
						<a href="#" class="card-aside-column br-tr-5  br-br-5 cover-image" data-image-src="{{URL::asset('assets/images/media/18.jpg')}}"></a>
					</div>
				</div><!-- COL-END -->
			</div>
			<!-- ROW-1 CLOSED -->
