...
@section('content')
				...
				<div class="row">
					<div class="col-md-12 col-lg-12">
						<div class="card">
							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="data-table2" class="table table-striped table-bordered w-100 text-nowrap display">
										<thead>
											<tr>
												<th>Name</th>
												<th>Age</th>
										...
										<tbody>
											...
											<tr>
												...
												<td><input type="text" class="form-control" id="row-18-position" name="row-18-position" value="Systems Web Developer"></td>
											...
											<tr>
												...
												<td><input type="text" class="form-control" id="row-53-position" name="row-53-position" value="Systems Web Developer"></td>
				...
				<div class="row">
					<div class="col-md-12 col-lg-12">
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">File export Datatables</h3>
							</div>
							<div class="card-body">
								<div class="table-responsive">
