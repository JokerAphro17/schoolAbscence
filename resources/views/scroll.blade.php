            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="imagescroll horizontal-images">
                                <ul>
                                    <li><img src="{{URL::asset('assets/images/media/13.jpg')}}" alt="" /></li>
                                    <li><img src="{{URL::asset('assets/images/media/14.jpg')}}" alt="" /></li>
                                    <li><img src="{{URL::asset('assets/images/media/15.jpg')}}" alt="" /></li>
                                    <li><img src="{{URL::asset('assets/images/media/16.jpg')}}" alt="" /></li>
                                    <li><img src="{{URL::asset('assets/images/media/17.jpg')}}" alt="" /></li>
                                    <li><img src="{{URL::asset('assets/images/media/18.jpg')}}" alt="" /></li>
                                    <li><img src="{{URL::asset('assets/images/media/19.jpg')}}" alt="" /></li>
                                    <li><img src="{{URL::asset('assets/images/media/20.jpg')}}" alt="" /></li>
                                </ul>
                            </div>
                        </div>
                    </div>
