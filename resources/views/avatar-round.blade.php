					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="avatarround1">
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="avatarround2">
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="avatarround3">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="avatar-list">
	<span class="avatar avatar-sm brround cover-image"  data-image-src="{{URL::asset('assets/images/users/15.jpg')}}"></span>
	<span class="avatar brround cover-image"  data-image-src="{{URL::asset('assets/images/users/13.jpg')}}"></span>
	<span class="avatar avatar-md brround cover-image"  data-image-src="{{URL::asset('assets/images/users/16.jpg')}}"></span>
						...
						<div class="card-body">
							<div class="text-wrap">
								<div class="example">
									...
									<!-- Prism Precode -->
									<figure class="highlight clip-widget" id="avatarround4">
										<pre><code class="language-markup"><script type="html-Yoha/script"><div class="avatar-list">
	<span class="avatar brround cover-image"  data-image-src="{{URL::asset('assets/images/users/19.jpg')}}"></span>
	<span class="avatar brround cover-image"  data-image-src="{{URL::asset('assets/images/users/15.jpg')}}">
		<span class="avatar-status bg-secondary"></span>
