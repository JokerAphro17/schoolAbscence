            ...
            <div class="row">
                <div class="col-xl-6 col-md-12">
                    ...
                    <figure class="highlight clip-widget" id="typo1">
                        <pre><code class="language-markup"><script type="html-Yoha/script"><h1>h1. Heading</h1>
<h2>h2. Heading</h2>
<h3>h3. Heading</h3>
<h4>h4. Heading</h4>
<h5>h5. Heading</h5>
<h6>h6. Heading</h6>
                ...
                <div class="col-xl-6 col-md-12">
                    ...
                    <figure class="highlight clip-widget" id="typo2">
                        <pre><code class="language-markup"><script type="html-Yoha/script"><h1 class="text-primary">h1. Heading</h1>
<h2  class="text-secondary">h2. Heading</h2>
<h3  class="text-success">h3. Heading</h3>
<h4  class="text-danger">h4. Heading</h4>
<h5  class="text-info">h5. Heading</h5>
            ...
            <div class="row">
                <div class="col-xl-6 col-md-12">
                    ...
                    <figure class="highlight clip-widget" id="typo3">
                        <pre><code class="language-markup"><script type="html-Yoha/script"><h1 class="heading-inverse">h1. Heading</h1>
<h2 class="heading-secondary">h2. Heading</h2>
<h3 class="heading-inverse">h3. Heading</h3>
<h4 class="heading-inverse">h4. Heading</h4>
<h5 class="heading-inverse">h5. Heading</h5>
<h6 class="heading-inverse">h6. Heading</h6>
                ...
                <div class="col-xl-6 col-md-12">
                    ...
                    <figure class="highlight clip-widget" id="typo4">
                        <pre><code class="language-markup"><script type="html-Yoha/script"><h1 class="heading-primary">h1. Heading</h1>
<h2 class="heading-secondary">h2. Heading</h2>
<h3 class="heading-success">h3. Heading</h3>
<h4 class="heading-info">h4. Heading</h4>
<h5 class="heading-warning">h5. Heading</h5>
<h6 class="heading-danger">h6. Heading</h6>
            ...
            <div class="row row-deck">
                <div class="col-lg-12 col-md-12">
                    ...
                    <!-- Prism Precode -->
                    <figure class="highlight clip-widget" id="typo5">
                        <pre><code class="language-markup"><script type="html-Yoha/script"><p class="leading-none">Lorem ipsum dolor sit amet.<br />
    Dolor sit amet.
</p>
<p class="leading-tight">Lorem ipsum dolor sit amet.<br />
    Dolor sit amet.
...
<p class="leading-loose m-0">Lorem ipsum dolor sit amet.<br />
    Dolor sit amet.
                ...
                <!-- Prism Precode -->
                <figure class="highlight clip-widget" id="typo6">
                    <pre><code class="language-markup"><script type="html-Yoha/script"><p class="text-left">Left aligned text on all viewport sizes.</p>
<p class="text-center">Center aligned text on all viewport sizes.</p>
<p class="text-right">Right aligned text on all viewport sizes.</p>
<p class="text-justify m-0">Both aligned text on all viewport sizes. Ambitioni dedisse scripsisse iudicaretur. Cras mattis iudicium purus sit amet fermentum. Donec sed odio operae, eu vulputate felis rhoncus.</p>
</script></code></pre>
            ...
            <div class="row">
                <div class="col-lg- col-md-12">
                    ...
                    <!-- Prism Precode -->
                    <figure class="highlight clip-widget" id="typo7">
                        <pre><code class="language-markup"><script type="html-Yoha/script"><p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
<p class="lead">Most designers set their type arbitrarily, either by pulling values out of the sky or by adhering to a baseline grid. The former case isn’t worth discussing here, but the latter requires a closer look.</p>
<p>You can use the mark tag to <mark>highlight</mark> text.</p>
</script></code></pre>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- Prism Precode -->
                    <figure class="highlight clip-widget" id="typo8">
                        <pre><code class="language-markup"><script type="html-Yoha/script"><p class="tracking-tight">Lorem ipsum dolor sit amet. Tight letter spacing.</p>
<p class="tracking-normal">Lorem ipsum dolor sit amet. Normal letter spacing.</p>
<p class="tracking-wide m-0">Lorem ipsum dolor sit amet. Wide letter spacing.</p>
</script></code></pre>
