                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right">
                                    <p class="mb-1"><span class="font-weight-bold">Invoice Date :</span> 01st February 2020</p>
                                    <p class="mb-0"><span class="font-weight-bold">Due Date :</span> 01 January 2021</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <table class="table table-bordered table-hover mb-0 text-nowrap">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right number-font1">$674</td>
                                            <td class="text-right number-font1">$1,308</td>
                                        </tr>
                                        <tr>
                                            <td class="text-center">2</td>
                                            <td>
                                            ...
                                            <td class="text-right number-font1">$1,500</td>
                                            <td class="text-right number-font1">$6,000</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-center">3</td>
                                            <td class="text-right number-font1">$530</td>
                                            <td class="text-right number-font1">$1,690</td>
                                        </tr>
                                        <tr>
                                            <td class="text-center">4</td>
                                            <td>
                                            ...
                                            <td class="text-center">2</td>
                                            <td class="text-right number-font1">$800</td>
                                            <td class="text-right number-font1">$1,600</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-center">2</td>
                                            <td class="text-right number-font1">$720</td>
                                            <td class="text-right number-font1">$1,440</td>
                                        </tr>
                                        <tr>
                                            <td colspan="4" class="font-weight-bold text-uppercase text-right">Total</td>
                                            <td class="font-weight-bold text-right h4 number-font1">$12,038</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
