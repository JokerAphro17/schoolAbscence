                ...
                <div class="col-12">
                    <div class="card Relatedpost nested-media">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Prism Code-->
                            <figure class="highlight clip-widget" id="media1">
                                <pre><code class="language-markup"><script type="html-Yoha/script"><div class="media media-lg">
    <img class="mr-3 mb-4" src="{{URL::asset('assets/images/media/media1.jpg')}}" alt="Generic placeholder image">
    <div class="media-body">
        <h4 class="mt-0">Media heading</h4>
        Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
                ...
                <div class="col-12">
                    <div class="card Relatedpost nested-media overflow-hidden">
                        ...
                        <div class="card-body overflow-hidden">
                            ...
                            <!-- Prism Code-->
                            <figure class="highlight clip-widget" id="media2">
                                <pre><code class="language-markup"><script type="html-Yoha/script"><div class="media media-lg">
    <img class="mr-3 mb-4" src="{{URL::asset('assets/images/media/media2.jpg')}}" alt="Generic placeholder image">
    <div class="media-body overflow-hidden">
        <h4 class="mt-0">Media heading</h4>
                        ...
                        <div class="card-body">
                            <div class="example">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="media media-lg mt-5 border-bottom-0">
                                    ...
                                    <li class="media media-lg border-bottom-0 mt-5">
                            ...
                            <!-- Prism Code-->
                            <figure class="highlight clip-widget" id="media3">
                                <pre><code class="language-markup"><script type="html-Yoha/script"><ul class="list-unstyled">
    <li class="media media-lg mt-0 border-bottom-0">
        <img class="mr-3 mb-4" src="{{URL::asset('assets/images/media/media4.jpg')}}" alt="Generic placeholder image">
        <div class="media-body">
            <h4 class="mt-0 mb-1">Media heading 01</h4>
                ...
                <div class="col-12">
                    <div class="card Relatedpost nested-media">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Prism Code-->
                            <figure class="highlight clip-widget" id="media4">
                                <pre><code class="language-markup"><script type="html-Yoha/script"><div class="media media-lg">
    <img class="align-self-start mr-3 mb-4" src="{{URL::asset('assets/images/media/media2.jpg')}}" alt="Generic placeholder image">
    <div class="media-body">
        <h4 class="mt-0">Top-aligned media</h4>
                ...
                <div class="col-12">
                    <div class="card Relatedpost nested-media ">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Prism Code-->
                            <figure class="highlight clip-widget" id="media5">
                                <pre><code class="language-markup"><script type="html-Yoha/script"><div class="media media-lg">
    <div class="media-body mt-0">
        <h4 class="mt-0 mb-4">Media object</h4>
        Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
