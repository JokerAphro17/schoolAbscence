...
@section('content')
            ...
            <div class="row">
                ...
                <figure class="highlight clip-widget" id="pagination1">
                    <pre><code class="language-markup"><script type="html-Yoha/script"><div class="pagination-wrapper">
    <nav aria-label="Page navigation">
        <ul class="pagination mb-0">
            <li class="page-item active">
                <a class="page-link" href="#">1</a>
            ...
            <div class="row">
                ...
                <figure class="highlight clip-widget" id="pagination2">
                    <pre><code class="language-markup"><script type="html-Yoha/script"><ul class="pagination">
    <li class="page-item page-prev disabled">
        <a class="page-link" href="#" tabindex="-1">Prev</a>
    </li>
    <li class="page-item active"><a class="page-link" href="#">1</a></li>
        ...
        <a class="page-link" href="#">Next</a>
            ...
            <div class="row">
                ...
                <figure class="highlight clip-widget" id="pagination3">
                    <pre><code class="language-markup"><script type="html-Yoha/script"><ul class="pagination mg-b-0 page-0">
    <li class="page-item">
        <a aria-label="Last" class="page-link" href="#"><i class="fa fa-angle-double-left"></i></a>
    </li>
    <li class="page-item">
        ...
        <a aria-label="Last" class="page-link" href="#"><i class="fa fa-angle-double-right"></i></a>
            ...
            <div class="row">
                ...
                <figure class="highlight clip-widget" id="pagination4">
                    <pre><code class="language-markup"><script type="html-Yoha/script"><nav aria-label="Page navigation">
    <ul class="pagination pagination-success mb-0">
        <li class="page-item page-0">
            <a aria-label="Next" class="page-link" href="#"><i class="fa fa-angle-left"></i></a>
        </li>
        ...
        <li class="page-item">
            ...
            <div class="row">
                ...
                <!-- Prism Precode -->
                <figure class="highlight clip-widget" id="pagination5">
                    <pre><code class="language-markup"><script type="html-Yoha/script"><nav aria-label="Page navigation example">
    <ul class="pagination">
        <li class="page-item">
            <a class="page-link" href="#" aria-label="Previous">
                <i class="fa fa-angle-left"></i>
        ...
        <li class="page-item">
            <a class="page-link" href="#" aria-label="Next">
                ...
                <!-- Prism Precode -->
                <figure class="highlight clip-widget" id="pagination6">
                    <pre><code class="language-markup"><script type="html-Yoha/script"><nav aria-label="Page navigation example">
    <ul class="pagination ">
        <li class="page-item disabled">
            <a class="page-link" href="#" tabindex="-1">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Prism Precode -->
                            <figure class="highlight clip-widget" id="pagination7">
                                <pre><code class="language-markup"><script type="html-Yoha/script"><nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center">
        <li class="page-item disabled">
            <a class="page-link" href="#" tabindex="-1">
        ...
        <li class="page-item">
            <a class="page-link" href="#">
                ...
                <!-- Prism Precode -->
                <figure class="highlight clip-widget" id="pagination8">
                    <pre><code class="language-markup"><script type="html-Yoha/script"><nav aria-label="Page navigation example">
    <ul class="pagination justify-content-end">
        <li class="page-item disabled">
            <a class="page-link" href="#" tabindex="-1">
