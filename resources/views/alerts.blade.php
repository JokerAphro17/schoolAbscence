					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight" id="alert1">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="alert alert-primary" role="alert">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>Primary alert—At vero eos et accusamus praesentium!
</div>
<div class="alert alert-secondary" role="alert">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>Secondary alert—At vero eos et accusamus praesentium!
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight" id="alert2">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="alert alert-success" role="alert">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<strong>Well done!</strong> You successfully read <a href="#" class="alert-link">this important alert message.</a>
</div>
<div class="alert alert-info" role="alert">
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight" id="alert3">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="alert alert-success" role="alert">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<i class="fa fa-check-circle-o mr-2" aria-hidden="true"></i> Well done! You successfully read this important alert message.
</div>
							...
							<div class="text-wrap">
								<div class="example">
									...
									<div class="alert alert-avatar  alert-success alert-dismissible">
										<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
										<span class="avatar brround cover-image" data-image-src="{{URL::asset('assets/images/users/5.jpg')}}"></span>
										Lorem ipsum dolor sit amet, consectetur adipisicing elit.
									</div>
								</div>
								<!-- Prism Precode -->
								<figure class="highlight" id="alert4">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="alert alert-avatar alert-primary alert-dismissible">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<span class="avatar brround cover-image" data-image-src="{{URL::asset('assets/images/users/14.jpg')}}"></span>
	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Lorem ipsum dolor sit amet, consectetur adipisicing elit.
</div>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight" id="alert5">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="alert alert-default" role="alert">
	<span class="alert-inner--icon"><i class="fe fe-download"></i></span>
	<span class="alert-inner--text"><strong>Default!</strong> This is a warning alert—check it out that has an icon too!</span>
</div>
<div class="alert alert-primary" role="alert">
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight" id="alert6">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="alert alert-default alert-dismissible fade show" role="alert">
	<span class="alert-inner--icon"><i class="fe fe-download"></i></span>
	<span class="alert-inner--text"><strong>Default!</strong> This is a default alert—check it out!</span>
	<button type="button" class="close" data-dismiss="alert" aria-label="Close">
		<span aria-hidden="true">×</span>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight" id="alert7">
									<pre><code class="language-markup"><script type="html-Yoha/script"><button type="button" class="btn btn-success btn-block" data-container="body" data-toggle="popover" data-popover-color="popsuccess" data-placement="bottom" title="alert sucess" data-content="Well done! You successfully read this important alert message..">
	Show success
</button>
<button type="button" class="btn btn-info btn-block" data-container="body" data-toggle="popover" data-popover-color="popinfo" data-placement="top" title="alert info" data-content="Heads up! This alert needs your attention, but it's not super important...">
	Show info
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap mb-4">
								...
								<!-- Prism Precode -->
								<figure class="highlight" id="alert8">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="alert alert-success">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<strong>Success Message</strong>
	<hr class="message-inner-separator">
	<p>You successfully read this important alert message.</p>
							...
							<div class="text-wrap mb-4">
								...
								<!-- Prism Precode -->
								<figure class="highlight" id="alert9">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="alert alert-info">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<strong>Info Message</strong>
	<hr class="message-inner-separator">
	<p>This alert needs your attention, but it's not super important.</p>
							...
							<div class="text-wrap mb-4">
								...
								<!-- Prism Precode -->
								<figure class="highlight" id="alert10">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="alert alert-warning">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<strong>Warning Message</strong>
	<hr class="message-inner-separator">
	<p>Best check yo self, you're not looking too good</p>
							...
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight" id="alert11">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="alert alert-danger">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<strong>Danger Message</strong>
	<hr class="message-inner-separator">
	<p>Change a few things up and try submitting again.</p>
