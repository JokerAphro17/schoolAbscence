					...
					<ul class="side-menu">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<li><a class="slide-item" href="{{url('/' . $page='index3')}}"><span>App Dashboard</span></a></li>
								<li><a class="slide-item" href="{{url('/' . $page='index4')}}"><span>LMS Dashboard</span></a></li>
								<li><a class="slide-item" href="{{url('/' . $page='index5')}}"><span>Analytics Dashboard</span></a></li>
							</ul>
						</li>
						<li>
							<h3>Widgets & Maps, Mails</h3>
						</li>
						<li class="slide">
						...
						<li class="slide">
							<a class="side-menu__item" href="{{url('/' . $page='eleves')}}">
								<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" class="side-menu__icon">
									<path d="M0 0h24v24H0V0z" fill="none" />
									<path d="M12 4C9.24 4 7 6.24 7 9c0 2.85 2.92 7.21 5 9.88 2.11-2.69 5-7 5-9.88 0-2.76-2.24-5-5-5zm0 7.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" opacity=".3" />
									<path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zM7 9c0-2.76 2.24-5 5-5s5 2.24 5 5c0 2.88-2.88 7.19-5 9.88C9.92 16.21 7 11.85 7 9z" />
						...
						<li class="slide">
							<a class="side-menu__item" href="{{url('/' . $page='abscences')}}">
								<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" class="side-menu__icon">
									<path d="M0 0h24v24H0V0z" fill="none" />
									<path d="M12 4C9.24 4 7 6.24 7 9c0 2.85 2.92 7.21 5 9.88 2.11-2.69 5-7 5-9.88 0-2.76-2.24-5-5-5zm0 7.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" opacity=".3" />
									<path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zM7 9c0-2.76 2.24-5 5-5s5 2.24 5 5c0 2.88-2.88 7.19-5 9.88C9.92 16.21 7 11.85 7 9z" />
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a href="{{url('/' . $page='email-compose')}}" class="slide-item">Mail-Compose</a></li>
								<li><a href="{{url('/' . $page='email-inbox')}}" class="slide-item">Mail-Inbox</a></li>
								<li><a href="{{url('/' . $page='email-view')}}" class="slide-item">View-Mail</a></li>
							</ul>
						</li>
						<li>
							<h3>Elements</h3>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<li><a href="{{url('/' . $page='dropdown')}}" class="slide-item"> Dropdowns</a></li>
								...
								<li><a href="{{url('/' . $page='list')}}" class="slide-item"> Lists & ListGroups</a></li>
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#">
								<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" class="side-menu__icon">
									...
									<path d="M20 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h15c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM8 19H5v-9h3v9zm7 0h-5v-9h5v9zm5 0h-3v-9h3v9zm0-11H5V5h15v3z" /></svg>
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#">
								<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" class="side-menu__icon">
									...
									<path d="M20 8l-6-6H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8zm-2 12H6V4h7v5h5v11z" /></svg>
							...
							<ul class="slide-menu">
								...
								<li><a href="{{url('/' . $page='wysiwyag')}}" class="slide-item"> Form Editor</a></li>
