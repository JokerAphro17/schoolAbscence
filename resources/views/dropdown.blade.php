				...
				<div class="col-md-6">
					<div class="card">
						...
						<div class="card-body">
							...
							<!-- Prism Precode -->
							<figure class="highlight clip-widget" id="dropdown1">
								<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-group mt-2 mb-2">
	<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
		Action <span class="caret"></span>
	</button>
	<ul class="dropdown-menu" role="menu">
...
<ul class="dropdown-menu" role="menu">
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="example panel panel-default">
								<div class="panel-body p-0">
									<div class="btn-group mt-2 mb-2">
										<button type="button" class="btn btn-outline-default btn-pill dropdown-toggle" data-toggle="dropdown">
											Action <span class="caret"></span>
										</button>
										<ul class="dropdown-menu" role="menu">
											<li class="dropdown-plus-title">
									...
									<div class="btn-group mt-2 mb-2">
										<button type="button" class="btn btn-outline-danger btn-pill dropdown-toggle" data-toggle="dropdown">
											Action <span class="caret"></span>
										</button>
										<ul class="dropdown-menu" role="menu">
											<li class="dropdown-plus-title">
	...
	</div><div class="btn-group mt-2 mb-2">
	<button type="button" class="btn btn-outline-primary btn-pill dropdown-toggle" data-toggle="dropdown">
		Action <span class="caret"></span>
	</button>
	<ul class="dropdown-menu" role="menu">
				...
				<div class="col-md-6">
					<div class="card">
						...
						<div class="card-body">
							...
							<!-- Prism Precode -->
							<figure class="highlight clip-widget" id="dropdown8">
								<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-group mt-2 mb-2">
	<button type="button" class="btn btn-pill btn-outline-primary">Action</button>
	<button type="button" class="btn btn-pill btn-outline-primary dropdown-toggle" data-toggle="dropdown">
		<span class="caret"></span>
				...
				<div class="col-md-6">
					<div class="card">
						...
						<div class="card-body">
							...
							<!-- Prism Precode -->
							<figure class="highlight clip-widget" id="dropdown9">
								<pre><code class="language-markup"><script type="html-Yoha/script"><div class="dropup btn-group mt-2 mb-2">
	<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Dropup1
		<span class="caret"></span></button>
	<ul class="dropdown-menu">
		<li><a href="#">HTML</a></li>
				...
				<div class="col-md-6">
					<div class="card">
						...
						<div class="card-body">
							...
							<!-- Prism Precode -->
							<figure class="highlight clip-widget" id="dropdown10">
								<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-group mt-2 mb-2">
	<button type="button" class="btn btn-facebook btn-pill dropdown-toggle" data-toggle="dropdown">
		<i class="fa fa-facebook"></i> <span class="caret"></span>
	</button>
