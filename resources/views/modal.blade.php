...
<!-- Prism Code-->
<figure class="highlight clip-widget" id="modal1">
    <pre><code class="language-markup"><script type="html-Yoha/script"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">View modal</button>
...
<!-- Prism Code-->
<figure class="highlight clip-widget" id="modal2">
    <pre><code class="language-markup"><script type="html-Yoha/script"><button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModalLong">View modal</button>
...
<!-- Prism Code-->
<figure class="highlight clip-widget" id="modal3">
    <pre><code class="language-markup"><script type="html-Yoha/script"><button class="btn btn-danger" data-toggle="modal" data-target="#largeModal">View modal</button>
...
<!-- Prism Code-->
<figure class="highlight clip-widget" id="modal4">
    <pre><code class="language-markup"><script type="html-Yoha/script"><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal2">View modal</button>

<!-- GRID MODAL -->
<div class="modal" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModal2" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<!-- Prism Code-->
<figure class="highlight clip-widget" id="modal5">
    <pre><code class="language-markup"><script type="html-Yoha/script"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#smallModal">View modal</button>
...
<!-- Prism Code-->
<figure class="highlight clip-widget" id="modal6">
    <pre><code class="language-markup"><script type="html-Yoha/script"><button type="button" class="btn btn-info" data-toggle="modal" data-target="#exampleModal3">View modal</button>

<!-- MESSAGE MODAL -->
<div class="modal" id="exampleModal3" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
