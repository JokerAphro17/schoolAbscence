					...
					<div class="card">
						...
						<div class="card-body">
							...
							<figure class="highlight clip-widget" id="breadcrumb1">
								<pre><code class="language-markup"><script type="html-Yoha/script"><ol class="breadcrumb1">
	<li class="breadcrumb-item1 active">Home</li>
	<li class="breadcrumb-item1 active">About</li>
</ol>
<ol class="breadcrumb1">
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<figure class="highlight clip-widget" id="breadcrumb2">
								<pre><code class="language-markup"><script type="html-Yoha/script"><div class="breadcrumb-3">
	<ol class="breadcrumb1">
		<li class="breadcrumb-item1"><a href="#">Home</a></li>
		<li class="breadcrumb-item1 active">about</li>
	</ol>
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<figure class="highlight clip-widget" id="breadcrumb3">
								<pre><code class="language-markup"><script type="html-Yoha/script"><div class="breadcrumb-1">
	<ol class="breadcrumb1">
		<li class="breadcrumb-item1"><a href="#">Home</a></li>
		<li class="breadcrumb-item1 active">about</li>
	</ol>
						...
						<div class="card-body">
							<div class="example">
								<ol class="breadcrumb1 bg-info">
									<li class="breadcrumb-item active text-white-50"><i class="fa fa-star-o mr-2 text-transparant" aria-hidden="true"></i>Home</li>
								</ol>
								<ol class="breadcrumb1 bg-success ">
									...
									<li class="breadcrumb-item active text-white-50"><i class="fa fa-star-o mx-2 text-transparant" aria-hidden="true"></i>Library</li>
								</ol>
								<ol class="breadcrumb1 bg-secondary">
									...
									<li class="breadcrumb-item active text-white-50"><i class="fa fa-star-o mx-2 text-transparant" aria-hidden="true"></i>Data</li>
								</ol>
							</div>
							<!-- Prism Precode -->
							<figure class="highlight clip-widget" id="breadcrumb4">
								<pre><code class="language-markup"><script type="html-Yoha/script"><ol class="breadcrumb1 bg-info">
