					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button1">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<a href="#" class="btn btn-default">Default</a>
	<a href="#" class="btn btn-primary">Primary</a>
	<a href="#" class="btn btn-secondary">Secondary</a>
	<a href="#" class="btn btn-success">Success</a>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button2">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<a href="#" class="btn btn-default-light">Default</a>
	<a href="#" class="btn btn-primary-light ">Primary</a>
	<a href="#" class="btn btn-secondary-light ">Secondary</a>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button3">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<a href="#" class="btn btn-primary disabled">Primary</a>
	<a href="#" class="btn btn-secondary disabled">Secondary</a>
	<a href="#" class="btn btn-success disabled">Success</a>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button4">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<a href="#" class="btn btn-primary-light disabled">Primary</a>
	<a href="#" class="btn btn-secondary-light disabled">Secondary</a>
	<a href="#" class="btn btn-success-light disabled">Success</a>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button5">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<a href="#" class="btn btn-blue">Blue</a>
	<a href="#" class="btn btn-azure">Azure</a>
	<a href="#" class="btn btn-indigo">Indigo</a>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button6">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<a href="#" class="btn btn-outline-default">Primary</a>
	<a href="#" class="btn btn-outline-primary">Primary</a>
	<a href="#" class="btn btn-outline-secondary">Secondary</a>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button7">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<a href="#" class="btn btn-radius btn-default">Default</a>
	<a href="#" class="btn btn-radius btn-primary">Primary</a>
	<a href="#" class="btn btn-radius btn-secondary">Secondary</a>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button8">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<a href="#" class="btn btn-radius btn-default-light">Default</a>
	<a href="#" class="btn btn-radius btn-primary-light ">Primary</a>
	<a href="#" class="btn btn-radius btn-secondary-light ">Secondary</a>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button9">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<a href="#" class="btn btn-pill btn-default">Default</a>
	<a href="#" class="btn btn-pill btn-primary">Primary</a>
	<a href="#" class="btn btn-pill btn-secondary">Secondary</a>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button10">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<a href="#" class="btn btn-pill btn-default-light">Default</a>
	<a href="#" class="btn btn-pill btn-primary-light">Primary</a>
	<a href="#" class="btn btn-pill btn-secondary-light">Secondary</a>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button11">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<button type="button" class="btn btn-dark"><i class="fe fe-upload mr-2"></i>Upload</button>
	<button type="button" class="btn btn-warning"><i class="fe fe-heart mr-2"></i>I like</button>
	<button type="button" class="btn btn-success"><i class="fe fe-check mr-2"></i>I agree</button>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button12">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<button type="button" class="btn btn-dark">Upload <i class="fa fa-upload fa-spin ml-2"></i></button>
	<button type="button" class="btn btn-warning">I like <i class="fa fa-heart fa-spin ml-2"></i></button>
	<button type="button" class="btn btn-success">I agree <i class="fa fa-check fa-spin ml-2"></i></button>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button13">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<div class="row">
		<div class="col-md-4 mb-2">
			<button type="button" class="btn btn-warning btn-sm mb-1">Small button</button>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button14">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<button type="button" class="btn btn-facebook"><i class="fa fa-facebook mr-2"></i>Facebook</button>
	<button type="button" class="btn btn-twitter"><i class="fa fa-twitter mr-2"></i>Twitter</button>
	<button type="button" class="btn btn-google"><i class="fa fa-google mr-2"></i>Google</button>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button15">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<button type="button" class="btn btn-icon btn-facebook"><i class="fa fa-facebook"></i></button>
	<button type="button" class="btn btn-icon btn-twitter"><i class="fa fa-twitter"></i></button>
	<button type="button" class="btn btn-icon btn-google"><i class="fa fa-google"></i></button>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button16">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<button type="button" class="btn btn-icon  btn-primary"><i class="fe fe-activity"></i></button>
	<button type="button" class="btn btn-icon  btn-github"><i class="fe fe-github"></i></button>
	<button type="button" class="btn btn-icon  btn-success"><i class="fe fe-bell"></i></button>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button17">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<button type="button" class="btn btn-primary btn-loading">Button text</button><br>
	<button type="button" class="btn btn-success btn-loading btn-icon"><i class="fe fe-check"></i></button>
	<button type="button" class="btn btn-warning btn-loading btn-sm">Button text</button><br>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button18">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<div class="dropdown">
		<button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown">
			<i class="fe fe-calendar"></i>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-wrap">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button19">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list">
	<a href="#" class="btn btn-primary">Save changes</a>
	<a href="#" class="btn btn-secondary">Save and continue</a>
	<a href="#" class="btn btn-danger">Cancel</a>
							...
							<div class="text-wrap mt-6">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button20">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="btn-list text-center">
	<a href="#" class="btn btn-primary">Save changes</a>
	<a href="#" class="btn btn-secondary">Save and continue</a>
	<a href="#" class="btn btn-danger">Cancel</a>
</div></script></code></pre>
							...
							<div class="text-wrap mt-6">
								...
								<!-- Prism Precode -->
								<figure class="highlight clip-widget" id="button21">
									<pre><code class="language-markup"><script type="html-Yoha/script"><div class="example">
	<div class="btn-list text-right">
		<a href="#" class="btn btn-primary">Save changes</a>
		<a href="#" class="btn btn-secondary">Save and continue</a>
		<a href="#" class="btn btn-danger">Cancel</a>
									...
									<div class="clipboard-icon" data-clipboard-target="#button21"><i class="fa fa-clipboard"></i></div>
								</figure>
								<!-- End Prism Precode -->
							</div>
						</div>
