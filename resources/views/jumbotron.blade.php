                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Prism Precode -->
                            <figure class="highlight clip-widget" id="jumb1">
                                <pre><code class="language-markup"><script type="html-Yoha/script"><div class="jumbotron">
    <h1 class="display-3">Hello, world!</h1>
    <p class="lead">This is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information.</p>
    <hr class="my-4">
    <p>It uses utility classes for typography and spacing to space content out within the larger container.</p>
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Prism Precode -->
                            <figure class="highlight clip-widget" id="jumb2">
                                <pre><code class="language-markup"><script type="html-Yoha/script"><div class="jumbotron">
    <div class="container">
        <h1 class="display-3">jumbotron</h1>
        <p class="lead m-0">This is a modified jumbotron that occupies the entire horizontal space of its parent.</p>
