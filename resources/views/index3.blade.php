						...
						<div class="card-body">
							<div class="row">
								<div class="col-xl-3 col-lg-2 text-center">
									<img src="{{URL::asset('assets/images/pngs/dash3.png')}}" alt="img" class="w-95">
								</div>
					...
					<div class="card">
						...
						<div class="card-body p-0">
							<div class="list d-flex align-items-center border-bottom p-3">
								<img alt="" class="d-block avatar-md bg-transparent" src="{{URL::asset('assets/images/svgs/categoreis/dash-256.svg')}}">
								<div class="wrapper w-100 ml-3">
									<div class="mb-0 d-flex mt-2">
										<div>
											<h5 class="mb-1 font-weight-semibold">Dash App</h5>
											<span class="mb-0 fs-13 text-muted"><i class="fa fa-apple text-muted mr-1"></i>Mac
												<small class="ml-1 fs-11 badge badge-secondary">Free</small>
											</span>
										</div>
										<div class="ml-auto">
							...
							<div class="list d-flex align-items-center border-bottom p-3">
								<img alt="" class="d-block avatar-md bg-transparent" src="{{URL::asset('assets/images/svgs/categoreis/google-duo.svg')}}">
								<div class="wrapper w-100 ml-3">
									<div class="mb-0 d-flex mt-2">
										<div>
											<h5 class="mb-1 font-weight-semibold">Google Due</h5>
											<span class="mb-0 fs-13 text-muted"><i class="mdi mdi-android text-muted mr-1"></i>Android
												<small class="ml-1 fs-11 badge badge-secondary">Free</small>
											</span>
										</div>
										<div class="ml-auto">
							...
							<div class="list d-flex align-items-center border-bottom p-3">
								<img alt="" class="d-block avatar-md bg-transparent" src="{{URL::asset('assets/images/svgs/categoreis/evernote.svg')}}">
								<div class="wrapper w-100 ml-3">
									<div class="mb-0 d-flex mt-2">
										<div>
											<h5 class="mb-1 font-weight-semibold">Evernote</h5>
											<span class="mb-0 fs-13 text-muted"><i class="fa fa-windows text-muted mr-1"></i>Windows
												<small class="ml-1 fs-11 badge badge-primary">$12</small>
											</span>
										</div>
										<div class="ml-auto">
											<span class="fs-12 text-yellow">
							...
							<div class="list d-flex align-items-center border-bottom p-3">
								<img alt="" class="d-block avatar-md bg-transparent" src="{{URL::asset('assets/images/svgs/categoreis/Shazam.svg')}}">
								<div class="wrapper w-100 ml-3">
									<div class="mb-0 d-flex mt-2">
										<div>
							...
							<div class="list d-flex align-items-center p-3">
								<img alt="" class="d-block avatar-md bg-transparent" src="{{URL::asset('assets/images/svgs/categoreis/picasa.svg')}}">
								<div class="wrapper w-100 ml-3">
									<div class="mb-0 d-flex mt-2">
										<div>
						...
						<div class="card-body p-0">
							<div class="table-responsive">
								<table class="table mb-0">
									<tbody>
										<tr>
											<td><span><i class="flag flag-um mr-2"></i>USA</span></td>
											<td><span><i class="bx bxl-android mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">6k</span></span></td>
											<td><span><i class="bx bxl-windows mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">5k</span></span></td>
											<td><span><i class="bx bxl-apple mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">3k</span></span></td>
										</tr>
										<tr>
											<td><span><i class="flag flag-ie mr-2"></i>Ireland</span></td>
											<td><span><i class="bx bxl-android mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">4k</span></span></td>
											<td><span><i class="bx bxl-windows mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">6k</span></span></td>
											<td><span><i class="bx bxl-apple mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">2k</span></span></td>
										</tr>
										<tr>
											<td><span><i class="flag flag-ca mr-2"></i>Canada</span></td>
											<td><span><i class="bx bxl-android mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">7k</span></span></td>
											<td><span><i class="bx bxl-windows mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">2k</span></span></td>
											<td><span><i class="bx bxl-apple mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">8k</span></span></td>
										</tr>
										<tr>
											<td><span><i class="flag flag-au mr-2"></i>Australia</span></td>
											<td><span><i class="bx bxl-android mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">1k</span></span></td>
											<td><span><i class="bx bxl-windows mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">3k</span></span></td>
											<td><span><i class="bx bxl-apple mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">5k</span></span></td>
										</tr>
										<tr>
											<td><span><i class="flag flag-ge mr-2"></i>Georgia</span></td>
											<td><span><i class="bx bxl-android mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">8k</span></span></td>
											<td><span><i class="bx bxl-windows mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">4k</span></span></td>
											<td><span><i class="bx bxl-apple mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">3k</span></span></td>
										</tr>
										<tr>
											<td><span><i class="flag flag-mq mr-2"></i>France</span></td>
											<td><span><i class="bx bxl-android mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">2k</span></span></td>
											<td><span><i class="bx bxl-windows mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">5k</span></span></td>
											<td><span><i class="bx bxl-apple mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">8k</span></span></td>
										</tr>
										<tr>
											<td><span><i class="flag flag-in mr-2"></i>India</span></td>
											<td><span><i class="bx bxl-android mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">4k</span></span></td>
											<td><span><i class="bx bxl-windows mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">1k</span></span></td>
											<td><span><i class="bx bxl-apple mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">3k</span></span></td>
										</tr>
										<tr>
											<td><span><i class="flag flag-it mr-2"></i>Italy</span></td>
											<td><span><i class="bx bxl-android mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">6k</span></span></td>
											<td><span><i class="bx bxl-windows mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">5k</span></span></td>
											<td><span><i class="bx bxl-apple mr-1 text-muted fs-20"></i><span class="mb-0 position-absolute fs-14">2k</span></span></td>
										</tr>
					...
					<div class="card">
						...
						<div class="card-body p-0 user-feedback">
							<div class="pl-3 pr-3 py-3 border-bottom">
								<div class="media mt-0">
									<div class="d-flex mr-3">
										<a href="#"><img alt="64x64" class="avatar-md rounded-circle mr-3" src="{{URL::asset('assets/images/users/2.jpg')}}"></a>
									</div>
									<div class="media-body">
										<div class="d-flex">
											<h6 class="mt-0 mb-0 font-weight-semibold">Samantha Wilson</h6>
											<span class="fs-12 ml-auto text-muted">
												<i class="fe fe-calendar mr-1"></i> 28 Feb 2020
											</span>
										</div>
										<div class="d-flex">
											<p class="tx-12 text-muted mb-0">long established fact..</p>
											<small class="ml-auto text-right fs-12 text-yellow">
												<i class="fa fa-star"></i>
												<i class="fa fa-star"></i>
												<i class="fa fa-star"></i>
												<i class="fa fa-star"></i>
							...
							<div class="pl-3 pr-3 py-3 border-bottom">
								<div class="media mt-0">
									<div class="d-flex mr-3">
										<a href="#"><img alt="64x64" class="avatar-md rounded-circle mr-3" src="{{URL::asset('assets/images/users/3.jpg')}}"></a>
									</div>
									<div class="media-body">
										<div class="d-flex">
							...
							<div class="pl-3 pr-3 py-3 border-bottom">
								<div class="media mt-0">
									<div class="d-flex mr-3">
										<a href="#"><img alt="64x64" class="avatar-md rounded-circle mr-3" src="{{URL::asset('assets/images/users/12.jpg')}}"></a>
									</div>
									<div class="media-body">
										<div class="d-flex">
							...
							<div class="pl-3 pr-3 py-3 border-bottom">
								<div class="media mt-0">
									<div class="d-flex mr-3">
										<a href="#"><img alt="64x64" class="avatar-md rounded-circle mr-3" src="{{URL::asset('assets/images/users/5.jpg')}}"></a>
									</div>
									<div class="media-body">
										<div class="d-flex">
							...
							<div class="pl-3 pr-3 py-3">
								<div class="media mt-0">
									<div class="d-flex mr-3">
										<a href="#"><img alt="64x64" class="avatar-md rounded-circle mr-3" src="{{URL::asset('assets/images/users/6.jpg')}}"></a>
									</div>
									<div class="media-body">
										<div class="d-flex">
