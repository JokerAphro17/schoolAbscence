...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    ...
                    <!-- Prism Precode -->
                    <figure class="highlight clip-widget" id="tag1">
                        <pre><code class="language-markup"><script type="html-Yoha/script"><div class="tags">
    <span class="tag">First tag</span>
    <span class="tag">Second tag</span>
    <span class="tag">Third tag</span>
</div></script></code></pre>
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <!-- Prism Precode -->
                    <figure class="highlight clip-widget" id="tag2">
                        <pre><code class="language-markup"><script type="html-Yoha/script"><div class="tags">
    <a href="#" class="tag">First tag</a>
    <a href="#" class="tag">Second tag</a>
    <a href="#" class="tag">Third tag</a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- Prism Precode -->
                    <figure class="highlight clip-widget" id="tag3">
                        <pre><code class="language-markup"><script type="html-Yoha/script"><div class="tags">
    <span class="tag tag-rounded">First tag</span>
    <span class="tag tag-rounded">Second tag</span>
    <span class="tag tag-rounded">Third tag</span>
                ...
                <div class="col-lg-12">
                    ...
                    <!-- Prism Precode -->
                    <figure class="highlight clip-widget" id="tag4">
                        <pre><code class="language-markup"><script type="html-Yoha/script"><div class="tags">
    <span class="tag tag-blue">Blue tag</span>
    <span class="tag tag-azure">Azure tag</span>
    <span class="tag tag-indigo">Indigo tag</span>
    ...
    <span class="tag tag-gray-dark">Dark gray tag</span>
                ...
                <!-- Prism Precode -->
                <figure class="highlight clip-widget" id="tag5">
                    <pre><code class="language-markup"><script type="html-Yoha/script"><div class="tags">
<span class="tag">
    <span class="tag-avatar avatar cover-image" data-image-src="{{URL::asset('assets/images/users/11.jpg')}}"></span>
    Victoria
...
<span class="tag">
    ...
    Debra
                ...
                <div class="col-lg-12">
                    ...
                    <!-- Prism Precode -->
                    <figure class="highlight clip-widget" id="tag6">
                        <pre><code class="language-markup"><script type="html-Yoha/script"><div class="tags">
    <span class="tag">First tag</span>
    <span class="tag">Second tag</span>
    <span class="tag">Third tag</span>
                    ...
                    <!-- Prism Precode -->
                    <figure class="highlight clip-widget" id="tag7">
                        <pre><code class="language-markup"><script type="html-Yoha/script"><div class="tags">
    <span class="tag">One</span>
    <span class="tag">Two</span>
    <span class="tag">Three</span>
    ...
    <span class="tag">Twenty</span>
                ...
                <div class="col-lg-12">
                    ...
                    <!-- Prism Precode -->
                    <figure class="highlight clip-widget" id="tag8">
                        <pre><code class="language-markup"><script type="html-Yoha/script"><div class="tags">
    <span class="tag">
        One
        <a href="javascript:void(0)" class="tag-addon"><i class="fe fe-x"></i></a>
    ...
    <span class="tag">
        ...
        <a href="javascript:void(0)" class="tag-addon"><i class="fe fe-x"></i></a>
                ...
                <div class="col-lg-12">
                                ...
                                <div class="example">
                                    <div class="tags">
                                        ...
                                        <div class="tag tag-danger">
                                            npm
                                            <span class="tag-addon tag-danger"><i class="fe fe-activity"></i></span>
                                        </div>
                    ...
                    <!-- Prism Precode -->
                    <figure class="highlight clip-widget" id="tag9">
                        <pre><code class="language-markup"><script type="html-Yoha/script"><div class="tags">
    <div class="tag">
        npm
        <a href="#" class="tag-addon"><i class="fe fe-x"></i></a>
