										...
										<form>
											...
											<div class="checkbox">
												<div class="custom-checkbox custom-control">
													...
													<label for="checkbox-1" class="custom-control-label">Check
														me Out</label>
												</div>
											</div>
										</form>
										...
										<form>
											...
											<div class="checkbox">
												<div class="custom-checkbox custom-control">
													...
													<label for="checkbox-2" class="custom-control-label">Check
														me Out</label>
												</div>
											</div>
										</form>
									...
									<div id="step-3" class="">
										<div class="checkbox">
											<div class="custom-checkbox custom-control">
												...
												<label for="checkbox3" class="custom-control-label">I agree
