                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="text-center mt-6">
                                <a href="#" class="btn btn-primary btn-block btn-lg">Choose plan</a>
                            </div>
                        </div>
                    </div>
                </div><!-- col-end -->
                <div class="col-sm-6 col-xl-3">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="text-center mt-6">
                                <a href="#" class="btn btn-warning btn-block btn-lg">Choose plan</a>
                            </div>
                        </div>
                    </div>
                </div><!-- col-end -->
                <div class="col-sm-6 col-xl-3">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="text-center mt-6">
                                <a href="#" class="btn btn-success btn-block btn-lg">Choose plan</a>
                            </div>
                        </div>
                    </div>
                </div><!-- col-end -->
                <div class="col-sm-6 col-xl-3">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="text-center mt-6">
                                <a href="#" class="btn btn-danger btn-block btn-lg">Choose plan</a>
                            </div>
                        </div>
                    </div>
                </div><!-- col-end -->
            ...
            <div class="row">
                <div class="col-sm-6 col-xl-3 primary">
                    <div class="princing-item mb-4">
                        ...
                        <div class="br-br-5 br-bl-5 bg-white mt-0  text-center">
                            <ul class="list-group list-group-flush text-center">
                                ...
                                <li class="list-group-item"><b>Help center access</b></li>
                            </ul>
                            <div class="card-footer">
                                <button type="button" class="btn btn-primary btn-block btn-lg">Sign up for free</button>
                            </div>
                        </div>
                    </div>
                </div><!-- COL-END -->
                <div class="col-sm-6 col-xl-3 secondary">
                    <div class="princing-item mb-4">
                        ...
                        <div class="br-br-5 br-bl-5 bg-white mt-0 text-center">
                            ...
                            <div class="card-footer">
                                <button type="button" class="btn btn-warning btn-block btn-lg">Sign up for free</button>
                            </div>
                        </div>
                    </div>
                </div><!-- COL-END -->
                <div class="col-sm-6 col-xl-3 success">
                    <div class="princing-item mb-4">
                        <div class="pricing-divider text-center">
                        ...
                        <div class="br-br-5 br-bl-5 bg-white mt-0 text-center">
                            ...
                            <div class="card-footer">
                                <button type="button" class="btn btn-success btn-block btn-lg">Sign up for free</button>
                            </div>
                        </div>
                    </div>
                </div><!-- COL-END -->
                <div class="col-sm-6 col-xl-3 info">
                    <div class="princing-item mb-4">
                        ...
                        <div class="br-br-5 br-bl-5 bg-white mt-0 text-center">
                            ...
                            <div class="card-footer">
                                <button type="button" class="btn btn-danger btn-block btn-lg">Sign up for free</button></div>
                        </div>
                    </div>
                </div><!-- COL-END -->
            </div>
                    ...
                    <div class="card">
                        <div class="card-body text-center pricing bg-primary">
                            ...
                            <div class="text-center mt-4">
                                <a href="#" class="btn btn-white btn-block btn-lg">Buy Now</a>
                            </div>
                        </div>
                    </div>
                </div><!-- COL-END -->
